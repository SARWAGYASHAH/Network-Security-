...
from networksecurity.utils.ml_utils.model.estimator import NetworkModel # this is for the new data
from networksecurity.utils.main_utils.utils import load_numpy_array_data,save_object,load_object,evaluate_models# this will return a pickle file
...
import dagshub
dagshub.init(repo_owner='SARWAGYASHAH', repo_name='Network-Security-', mlflow=True)
...
class ModelTrainer:
    ...
    def train_model(self,X_train,y_train,x_test,y_test):
        ...
        params={# hyper paramter of each model
            "Decision Tree": {
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            ...
            x_train, y_train, x_test, y_test = (# segregation of input and output features in both train and test data
                train_arr[:, :-1],
                train_arr[:, -1],
                test_arr[:, :-1],
                test_arr[:, -1],
